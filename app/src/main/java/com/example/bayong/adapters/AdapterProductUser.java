...
import com.example.bayong.FilterProductUser;
...
public class AdapterProductUser extends RecyclerView.Adapter<AdapterProductUser.HolderProductUser> implements Filterable {
    ...
    private void showQuantityDialog(ModelProduct modelProduct) {
        ...
        cost = Double.parseDouble(price.replaceAll("Php", ""));
        finalCost = Double.parseDouble(price.replaceAll("Php", ""));
        quantity = 1;
        ...
        originalPriceTv.setText("Php"+modelProduct.getOriginalPrice());
        priceDiscountedTv.setText("Php"+modelProduct.getDiscountPrice());
        finalPriceTv.setText("Php"+finalCost);
        ...
        continueBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String totalPrice = finalPriceTv.getText().toString().trim().replace("Php","");
