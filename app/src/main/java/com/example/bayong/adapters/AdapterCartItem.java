...
import com.example.bayong.activities.ShopDetailsActivity;
    ...
    public void onBindViewHolder(@NonNull HolderCartItem holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.itemRemoveTv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //will create table if not exist, but in that case wil must exist
                ...
                double tx = Double.parseDouble((((ShopDetailsActivity)context).allTotalPriceTv.getText().toString().trim().replace("Php","")));
                double totalPrice = tx - Double.parseDouble(cost.replace("Php", ""));
                double deliverFee = Double.parseDouble((((ShopDetailsActivity)context).deliveryFee.replace("Php","")));
                ...
                ((ShopDetailsActivity)context).sTotalTv.setText("Php"+String.format("%.2f", sTotalPrice));
                ((ShopDetailsActivity)context).allTotalPriceTv.setText("Php"+String.format("%.2f", Double.parseDouble(String.format("%.2f", totalPrice))));
