...
import com.example.bayong.FilterOrderShop;
import com.example.bayong.R;
import com.example.bayong.activities.OrderDetailsSellerActivity;
...
public class AdapterOrderShop extends RecyclerView.Adapter<AdapterOrderShop.HolderOrderShop> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull HolderOrderShop holder, int position) {
        ...
        //set data
        holder.amountTv.setText("Amount: Php" + orderCost);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("orderBy", orderBy);//to load info of the one who order
